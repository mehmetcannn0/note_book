...
import 'package:note_book/views/search/search_controller.dart';
...
class SearchPage extends GetWidget<SearchController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(searchAppBarText),
  ...
  Widget _buildNoItemCard() {
    return Obx(() =>
        controller.isNoResultFound.value && !controller.isnoteNameNotEmpty.value
            ? Container(
    ...
    return AnimatedContainer(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              "$index. -> " + controller.noteNameList[index].toString(),
            ),
            // Text()
          ],
        ),
